...
void MenuUI::loadUI(const std::string& file)
{
    ...
    auto labelTitle = Label::createWithTTF("超级生命", "FZXS12.TTF", 120);
    ...
    m_pQuestModeBtn->setTitleFontName("FZXS12.TTF");
    m_pQuestModeBtn->setTitleColor(color);
    m_pQuestModeBtn->setTitleFontSize(24);
    m_pQuestModeBtn->setTitleText("任务模式");
    ...
    m_pFreeModeBtn->setTitleFontName("FZXS12.TTF");
    m_pFreeModeBtn->setTitleColor(color);
    m_pFreeModeBtn->setTitleFontSize(24);
    m_pFreeModeBtn->setTitleText("自由模式");
    ...
    m_pHelpBtn->setTitleFontName("FZXS12.TTF");
    m_pHelpBtn->setTitleColor(color);
    m_pHelpBtn->setTitleFontSize(24);
    m_pHelpBtn->setTitleText("说明与帮助");
    m_pHelpBtn->setColor(color);
    this->addChild(m_pHelpBtn);

    auto labelMadeBy = Label::createWithTTF("Made by Irenicus", "r-plaza_8.ttf", 10);
